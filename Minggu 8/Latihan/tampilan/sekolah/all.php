...
?> 
<a class="btn pull-right" href="beranda.php?p=home">Tambah Baru</a> 
<h2>Data Sekolah</h2> 
<div style="clear:both;width:200px;margin-right:12px;" class="pull-right"> 
    <form action="beranda.php?p=sekolah&m=search"> 
...
<div style="clear:both">&nbsp;</div> 
    ...
    <tr>
        ...
        <td><a href="beranda.php?p=sekolah&m=edit&id=<?php echo $key['id'];?>">Ubah</a></td> 
